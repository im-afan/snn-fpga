# 0 "C:\\Users\\andre\\Desktop\\snn-fpga\\vitis\\ws\\platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\andre\\Desktop\\snn-fpga\\vitis\\ws\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\andre\\Desktop\\snn-fpga\\vitis\\ws\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  axi_bram_ctrl_1: axi_bram_ctrl@c2000000 {
   xlnx,protocol = "AXI4";
   xlnx,edk-special = "BRAM_CTRL";
   compatible = "xlnx,axi-bram-ctrl-4.1";
   xlnx,ecc-onoff-reset-value = <0>;
  ...
  axi_bram_ctrl_2: axi_bram_ctrl@c4000000 {
   xlnx,protocol = "AXI4";
   xlnx,edk-special = "BRAM_CTRL";
   compatible = "xlnx,axi-bram-ctrl-4.1";
   xlnx,ecc-onoff-reset-value = <0>;
  ...
  axi_bram_ctrl_3: axi_bram_ctrl@c6000000 {
   xlnx,protocol = "AXI4";
   xlnx,edk-special = "BRAM_CTRL";
   compatible = "xlnx,axi-bram-ctrl-4.1";
   xlnx,ecc-onoff-reset-value = <0>;
...
# 3 "C:\\Users\\andre\\Desktop\\snn-fpga\\vitis\\ws\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7a35t";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0xC0000000 &axi_bram_ctrl_0_memory 0xC0000000 0x2000>,
         ...
         <0xC4000000 &axi_bram_ctrl_2_memory 0xC4000000 0x2000>,
         <0xC4000000 &axi_bram_ctrl_2 0xC4000000 0x2000>,
