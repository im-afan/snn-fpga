...
PATH = "/Users/andre/Desktop/snn-fpga"
print(PATH + "/vitis/ws")
...
comp = client.create_app_component(name="app_component_mnist",platform = PATH + "/vitis/ws/platform/export/platform/platform.xpfm",domain = "standalone_microblaze_0")
comp.import_files(from_loc=PATH + "/src/c/", files=["main_mnist.c", "snn_driver.h", "model_params.h"], dest_dir_in_cmp="src")
